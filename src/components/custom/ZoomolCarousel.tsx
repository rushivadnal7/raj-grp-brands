...
const ZoomolCarousel = ({ images }: { images: Image[] }) => {
    ...
    return (
        <div className="relative py-10 w-full flex justify-center items-center max-sm:py-14">
                    ...
                    {images.map((c: Image, index: number) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    className={`flex ${c.detail === "<p>Gear &<br/>Transformer Oil</p>"
                                            ? "w-[130%] -ml-4"
                                            : "w-fit mx-auto"
                                        } space-x-3 p-5 mt-4`}
                                >
                                    ...
                                    <div
                                        ...
                                        className={`text-left w-full flex ${c.detail === "<p>Gear &<br/>Transformer Oil</p>"
                                                ? "justify-start"
                                                : "justify-center"
            ...
            <nav
                className="absolute z-20 bottom-6 flex space-x-3"
                aria-label="Carousel navigation"
            >
                {images.map((item: Image, index: number) => (
                    <button
                        key={index}
                        className={`size-3 sm:size-4 rounded-full cursor-pointer transition-colors duration-300 ${currentIndex === index ? "bg-[#da2616]" : "bg-gray-300"
